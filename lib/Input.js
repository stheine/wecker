...
//    console.log('Input:constructor');
    ...
    // Rotary Encoder - 1
    this.rotaryEncoder1 = new InputEvent.Rotary('/dev/input/by-path/platform-rotary@10-event');
    this.rotaryEncoder1.on('left', async(/* data */) => {
//      console.log('Input:rotary1 left');
...
//      console.log('Input:rotary1 right');
    ...
    // Rotary Button - 1
    this.rotaryButton1 = new InputEvent.Keyboard('/dev/input/by-path/platform-button@15-event');
    this.rotaryButton1.on('keypress', async(/* data */) => {
//      console.log('Input:button1 press');
...
//      console.log('Input:button1 up');
    ...
    // Rotary Encoder - 2
    this.rotaryEncoder2 = new InputEvent.Rotary('/dev/input/by-path/platform-rotary@5-event');
    this.rotaryEncoder2.on('left', async(/* data */) => {
//      console.log('Input:rotary2 left');
...
//      console.log('Input:rotary2 right');
    ...
    // Rotary Button - 2
    this.rotaryButton2 = new InputEvent.Keyboard('/dev/input/by-path/platform-button@d-event');
    this.rotaryButton2.on('keypress', async(/* data */) => {
//      console.log('Input:button2 press');
