...
const font18 = require('../fonts/oled-js-font-Consolas-18-225'); // 3 lines menu
const font20 = require('../fonts/oled-js-font-Consolas-20-230');
const font26 = require('../fonts/oled-js-font-Consolas-26-230'); // 2 lines menu
const font46 = require('../fonts/oled-js-font-Consolas-46-150');
const font50 = require('../fonts/oled-js-font-Consolas-50-150');
const font55 = require('../fonts/oled-js-font-Consolas-55-146');
/* eslint-enable no-unused-vars */

const fontMenu = font26;
...
class Render {
  ...
  async renderTime(params) {
    ...
    this.oled.writeString(-4, -15, font55, _.padStart(params.moment.format('H'), 2), 'WHITE', false);
    this.oled.writeString(70, -15, font55, params.moment.format('mm'), 'WHITE', false);
...
//      console.log('cleanLower');
  ...
  async renderVolume(params) {
    ...
    const volumeX = Math.round(127 * Math.log(params.volume + 1) / Math.log((100 * 2) + 1));
