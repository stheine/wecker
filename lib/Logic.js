...
const backToTimeDisplayTimeout = ms('5 seconds');
const volumeTimeout            = ms('2 seconds');
...
class Logic {
  constructor({alarm, logger, render, stream}) {
    ...
    this.jobDimOff = new Cron('0 30 7 * * *', {timezone: 'Europe/Berlin'}, () => {
      this.render.dim = 255;
    });
    this.jobDimOn  = new Cron('0 30 22 * * *', {timezone: 'Europe/Berlin'}, () => {
      this.render.dim = 0;
    });
  }
